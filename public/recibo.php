...
<head>
    <meta charset="UTF-8">
    <title>Recibo Pedido #<?php echo $pedido['id']; ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
            ...
            <tbody>
                <?php foreach ($pedido['itens'] as $item): ?>
                    <tr>
                        ...
                        <td class="col-valor">R$ <?php echo number_format($item['quantidade'] * $item['preco_unitario'], 2, ',', '.'); ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
        <hr>
        <p class="total">Total: R$ <?php echo number_format($pedido['valor_total'], 2, ',', '.'); ?></p>
